...
{% infobox %}
The `intersects` command cannot take advantage of a geospatial [secondary index](/docs/secondary-indexes/ruby). If you're working with large data sets, you should consider using an index and the [get_intersecting](/api/ruby/get_intersecting) command instead of `intersects`.
{% endinfobox %}
